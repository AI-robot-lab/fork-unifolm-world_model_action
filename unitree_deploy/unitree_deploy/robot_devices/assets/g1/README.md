...
## Wizualizacja w [MuJoCo](https://github.com/google-deepmind/mujoco)

1. Otwórz MuJoCo Viewer
...
2. Przeciągnij plik modelu MJCF/URDF (`g1_XXX.xml`/`g1_XXX.urdf`) do MuJoCo Viewer.

## Uwaga dotycząca teleoperacji
g1_body29_hand14 jest zmodyfikowany na podstawie [g1_29dof_with_hand_rev_1_0](https://github.com/unitreerobotics/unitree_ros/blob/master/robots/g1_description/g1_29dof_with_hand_rev_1_0.urdf)
